        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-brand-blue/5 dark:bg-brand-yellow/5 px-4 py-2 rounded-full border border-brand-blue/10 dark:border-brand-yellow/10 mb-6">
              <Icon name="FileText" className="w-4 h-4 text-brand-blue dark:text-brand-yellow" />
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-4">
              Terms of <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue dark:from-brand-yellow to-brand-blue/60 dark:to-brand-yellow/60">Service</span>
            </h1>
      ...
      <section className="relative pb-24">
        <div className="max-w-4xl mx-auto px-6 md:px-8">
          ...
          >
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="BookOpen" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                2. Definitions
              </h2>
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Briefcase" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Star" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Ban" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                6. Acceptable Use
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">You agree NOT to:</p>
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li className="flex items-start gap-2">
                  <Icon name="X" className="w-4 h-4 text-brand-blue dark:text-brand-yellow mt-1 flex-shrink-0" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Copyright" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="CreditCard" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="AlertTriangle" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                9. Disclaimers
              </h2>
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Shield" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Gavel" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                11. Indemnification
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="XCircle" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                12. Termination
              </h2>
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Scale" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="ListChecks" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                15. Miscellaneous
              </h2>
