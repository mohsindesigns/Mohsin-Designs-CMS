    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-background overflow-hidden pt-32 pb-16">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgb(var(--color-brand-accent-rgb)/0.08)_0%,_transparent_70%)]" />
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-blue/20 dark:via-brand-yellow/20 to-transparent" />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            />
            <div className="inline-flex items-center gap-2 bg-brand-blue/5 dark:bg-brand-yellow/5 px-4 py-2 rounded-full border border-brand-blue/10 dark:border-brand-yellow/10 mb-6">
              <Icon name="Shield" className="w-4 h-4 text-brand-blue dark:text-brand-yellow" />
              <span className="text-brand-blue dark:text-brand-yellow uppercase tracking-wider text-xs font-semibold">Legal</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-4">
              Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue dark:from-brand-yellow to-brand-blue/60 dark:to-brand-yellow/60">Policy</span>
            </h1>
          ...
          >
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Info" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                1. Introduction
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Mohsin Designs ("we," "our," or "us") operates the website{' '}
                <a href="https://mohsindesigns.com" className="text-brand-blue dark:text-brand-yellow hover:underline">mohsindesigns.com</a>{' '}
              ...
              <div className="mt-4 p-4 bg-brand-blue/5 dark:bg-brand-yellow/5 border border-brand-blue/20 dark:border-brand-yellow/20 rounded-xl">
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Database" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
              ...
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li className="flex items-start gap-2">
                  <Icon name="Check" className="w-4 h-4 text-brand-blue dark:text-brand-yellow mt-1 flex-shrink-0" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Settings" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-gradient-to-r from-brand-blue/5 dark:from-brand-yellow/5 via-card to-brand-blue/5 dark:to-brand-yellow/5 rounded-2xl border border-brand-blue/20 dark:border-brand-yellow/20 p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="ShieldCheck" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Lock" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Clock" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
                6. Data Retention
              </h2>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Share2" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Cookie" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="UserCheck" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
              ...
              <div className="p-4 bg-brand-blue/5 dark:bg-brand-yellow/5 border border-brand-blue/20 dark:border-brand-yellow/20 rounded-xl">
                <p className="text-sm text-muted-foreground">
                  To exercise these rights, email us at{' '}
                  <a href="mailto:info@mohsindesigns.com" className="text-brand-blue dark:text-brand-yellow hover:underline">info@mohsindesigns.com</a>.
                </p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Baby" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="Globe" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="ExternalLink" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
              ...
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li className="flex items-start gap-2">
                  <Icon name="Check" className="w-4 h-4 text-brand-blue dark:text-brand-yellow mt-1 flex-shrink-0" />
                  <span>
                    <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-brand-blue dark:text-brand-yellow hover:underline">Google Privacy Policy</a>
                  </span>
                </li>
              </ul>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                <Icon name="RefreshCw" className="w-5 h-5 text-brand-blue dark:text-brand-yellow" />
            ...
            {/* Contact */}
            <div className="bg-gradient-to-r from-brand-blue/10 dark:from-brand-yellow/10 via-card to-brand-blue/10 dark:to-brand-yellow/10 rounded-2xl border border-brand-blue/30 dark:border-brand-yellow/30 p-6 md:p-8 text-center">
              <Icon name="Mail" className="w-10 h-10 text-brand-blue dark:text-brand-yellow mx-auto mb-4" />
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-brand-blue dark:text-brand-yellow hover:underline font-semibold"
              >
