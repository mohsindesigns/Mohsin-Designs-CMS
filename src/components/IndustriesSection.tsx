...
export default function IndustriesSection({ data }: IndustriesSectionProps) {
  ...
  return (
    <section id="industries" className="relative overflow-hidden border-b border-brand-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-transparent section-y">
