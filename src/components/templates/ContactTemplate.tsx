                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                      <ThemedSelect
                        ...
                        options={hero.form.services.map((srv: string, idx: number) => ({ value: srv, label: srv, disabled: idx === 0 }))}
                      />
        ...
        {((office as any)?.enabled !== false && (rawData as any).office?.enabled !== false) && (
          <section className="section-gap">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-7 min-w-0 bg-white dark:bg-[#12121e] border border-brand-zinc-200/90 dark:border-white/10 rounded-[28px] overflow-hidden shadow-lg min-h-[380px] relative group">
                <iframe
              ...
              <div className="lg:col-span-5 min-w-0 bg-white dark:bg-[#12121e] border border-brand-zinc-200/90 dark:border-white/10 p-7 sm:p-9 rounded-[28px] shadow-lg flex flex-col justify-between space-y-6">
              ...
              <div className="relative z-10 flex flex-col justify-center gap-6 p-8 sm:p-12 lg:p-14 lg:max-w-[62%]">
                ...
                <div className="flex items-center gap-4 flex-wrap pt-2">
                  ...
                  {ctaBanner.ctaSecondary && (
                    <CtaButton href={ctaBanner.ctaSecondary.href} target="_blank" rel="noopener noreferrer" variant="secondary">{ctaBanner.ctaSecondary.label}</CtaButton>
                  )}
                </div>
              </div>
