...
export default function ContactForm({ data }: { data?: any }) {
 ...
 <span className="text-brand-blue dark:text-brand-yellow font-cursive font-normal">
          ...
          <div className="lg:col-span-7 min-w-0 w-full bg-white dark:bg-[#12121e] border border-brand-zinc-200/80 dark:border-white/10 p-6 sm:p-9 md:p-11 rounded-[2.5rem] shadow-[0_20px_60px_rgba(3,6,172,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.4)] relative overflow-hidden">
