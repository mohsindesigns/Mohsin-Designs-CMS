        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-stretch">
          ...
          >
            ...
            <motion.h1
              ...
              className="font-heading text-3xl/[1.08] sm:text-4xl/[1.08] md:text-5xl/[1.08] lg:text-[50px]/[1.08] font-semibold tracking-tight text-brand-dark dark:text-white select-none"
            >
              {titleLine1}
